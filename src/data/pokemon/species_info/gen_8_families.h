...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DIPPLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_HYDRAPPLE}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color, rzMode)                                      \
    ...
    [SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM] = ALCREMIE_REGULAR_SPECIES_INFO(Strawberry, VanillaCream, BODY_COLOR_WHITE, MON_RANDOMIZER_INVALID),
    ...
    [SPECIES_ALCREMIE_STAR_MATCHA_CREAM]        = ALCREMIE_REGULAR_SPECIES_INFO(Star,       MatchaCream,  BODY_COLOR_GREEN, MON_RANDOMIZER_NORMAL),
